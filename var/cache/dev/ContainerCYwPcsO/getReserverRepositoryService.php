 ...
 */
class getReserverRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReserverRepository' shared autowired service.
     *
     * @return \App\Repository\ReserverRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReserverRepository.php';

        return $container->privates['App\\Repository\\ReserverRepository'] = new \App\Repository\ReserverRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
